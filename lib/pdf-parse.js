...
async function PDF(dataBuffer, options) {
    ...
    if (typeof options.firstPage != 'number') options.firstPage = DEFAULT_OPTIONS.firstPage;
    if (typeof options.lastPage != 'number') options.lastPage = DEFAULT_OPTIONS.lastPage;
    ...
    let counter = options.lastPage >= options.firstPage && options.lastPage <= doc.numPages ? options.lastPage : doc.numPages;

    let i = options.firstPage <= doc.numPages ? options.firstPage : 1;
